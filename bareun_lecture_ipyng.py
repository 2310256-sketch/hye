# -*- coding: utf-8 -*-
"""bareun_lecture.ipyng

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18MYaBZ1PD_Il4MbHil3871m-Sku0Iqfn
...
# pip install 명령어로 필요한 패키지를 설치합니다.
# 앞의 '!'는 Colab/Jupyter에서 터미널 명령어를 실행할 때 사용합니다.
# '-q' 옵션은 설치 과정의 불필요한 출력을 줄여줍니다 (quiet 모드).

!pip install bareunpy -q
!pip install wordcloud matplotlib pandas openpyxl -q

# 한글 폰트 설치 — 이 단계를 빠뜨리면 그래프에서 한글이 □로 표시됩니다.
!apt-get install -y fonts-nanum -q
!fc-cache -fv -q   # 시스템 폰트 캐시 갱신
...
# 시스템에 설치된 폰트 중 'NanumGothic'을 찾습니다.
font_path = None
